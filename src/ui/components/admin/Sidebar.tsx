...
// Definimos el tipo de las props que el componente Sidebar acepta
...
const Sidebar: React.FC<SidebarProps> = ({ isVisible }) => (
	<SidebarContainer style={{ display: isVisible ? 'block' : 'none' }}>
		...
		<SidebarFooter>
			<img src={Escudo_Universidad_Autónoma_Tomás_Frías} alt="Logo Universidad Autónoma Tomás Frías" style={{ width: '50px', marginBottom: '0.5rem' }} />
