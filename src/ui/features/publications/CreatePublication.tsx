...
import { FormCard, FormHeader } from './organisms/createPublicationForm/createPublicationStyles';
...
const CreatePublication: React.FC<Props> = ({ onPublicationCreated }) => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const msg = err?.message || 'Error al crear la publicación';
			alert(msg);
			console.error(err);
		}
	};
			...
			<Collapse in={open}>
				<form onSubmit={handleSubmit}>
					<PublicationFormBody>
						...
						<FormFileInput onChange={handleFile} />
