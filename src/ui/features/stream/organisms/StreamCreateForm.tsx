...
import { validateStreamTitle, validateStreamDescription, } from '../../../shared/utils/validation/validators';
...
const StreamCreateForm: React.FC<Props> = ({
	...
	const titleError = useMemo(
		() => (touched.title ? (validateStreamTitle(title) || '') : ''),
		[title, touched.title],
	);

	const descError  = useMemo(
		() => (touched.desc ? (validateStreamDescription(description) || '') : ''),
	...
	const isFormValid =
		!validateStreamTitle(title) &&
		!validateStreamDescription(description) &&
		isCareerValid &&
		isCodeValid;
